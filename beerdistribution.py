...
Authors: Anthony Phillips, Dr Stuart Mitchell 2007

Rewritten by Peadar Coyle 2014
"""
...
# Creates a dictionary for the number of units of each supply node
supply = {"A":1000,
        "B": 4000}
...
# Supply maximimum constainsts are added to prob for each supply node 
# (warehouse)
for w in warehouses:
...
# Each of the variables is printed when it's resolved optimum value
